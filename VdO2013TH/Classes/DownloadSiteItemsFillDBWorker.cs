...
namespace VdO2013TH
{
    ...
    internal class DownloadSiteItemsFillDBWorker : BackgroundWorkerEx
    {
        public DownloadSiteItemsFillDBWorker()
            : base(BackgroundWorkerBlocking.UserInterface)
        {
            this.WorkerReportsProgress = true;
            this.DoWork += new DoWorkEventHandler(DownloadSiteItemsFillDB);
            this.ProgressChanged += new ProgressChangedEventHandler(DownloadSiteItemsFillDBProgressChanged);
            this.RunWorkerCompleted += new RunWorkerCompletedEventHandler(DownloadSiteItemsFillDBCompleted);
        }
